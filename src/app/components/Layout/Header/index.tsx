        ...
        <nav className="flex flex-col p-3 bg-white">
          ...
          <div className="pt-3 px-1 pb-2">
            <Link
              href="/contact"
              onClick={() => setNavbarOpen(false)}
              className="flex items-center justify-center gap-2 w-full py-3.5 px-6 rounded-2xl bg-gradient-to-r from-blue-600 via-sky-600 to-blue-700 text-white font-bold text-sm tracking-wide uppercase shadow-[0_4px_16px_rgba(0,82,204,0.3)] active:scale-98 transition-all"
            >
              <span>Let's Talk</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
